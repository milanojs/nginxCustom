#define NGX_CONFIGURE " --prefix=/etc/nginx --sbin-path=/usr/sbin/nginx --modules-path=/usr/lib/nginx/modules --conf-path=/etc/nginx/nginx.conf --error-log-path=/var/log/nginx/error.log --http-log-path=/var/log/nginx/access.log --pid-path=/var/run/nginx.pid --lock-path=/var/run/nginx.lock --http-client-body-temp-path=/var/cache/nginx/client_temp --http-proxy-temp-path=/var/cache/nginx/proxy_temp --http-fastcgi-temp-path=/var/cache/nginx/fastcgi_temp --http-uwsgi-temp-path=/var/cache/nginx/uwsgi_temp --http-scgi-temp-path=/var/cache/nginx/scgi_temp --with-debug --with-stream_ssl_module --with-http_stub_status_module --with-stream --with-http_geoip_module --with-http_sub_module --with-http_mp4_module --with-http_realip_module --with-http_addition_module --with-http_flv_module --with-http_gunzip_module --with-http_gzip_static_module --with-http_random_index_module --with-http_auth_request_module --with-mail --with-mail_ssl_module --with-file-aio --with-http_secure_link_module --user=nginx --group=nginx --with-http_ssl_module --with-http_dav_module --add-module=../nginx-dav-ext-module-3.0.0 --add-module=../nginx-rtmp-module-1.2.1 --add-module=../headers-more-nginx-module-0.33 --add-module=../nginx-module-vts-0.1.18 --add-module=../nginx-vod-module-1.24 --with-debug"
